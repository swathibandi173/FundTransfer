...
public class FundTransferDto {
	 @Size(min = 5, max = 13)
	 @NotNull(message="Please provide only digits")
	...
	public FundTransferDto(
			@Size(min = 5, max = 13) @NotNull(message = "Please provide only digits") @Pattern(regexp = "[0-9]{13}", message = "provide a valid from account no") String fromAccountNo,
			@Size(min = 5, max = 13) @NotNull(message = "Please provide only digits") @Pattern(regexp = "[0-9]{13}", message = "provide a valid to account no") String toAccountNo,
